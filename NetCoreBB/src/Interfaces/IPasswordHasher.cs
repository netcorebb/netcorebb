...
namespace NetCoreBB.Interfaces
{
    ...
    public interface IPasswordHasher
    {
        ...
        Option<string> Hash(string password);
        ...
        Option<(bool, TimeSpan)> Verify(string password, string hash);
        ...
        bool Decode(string hash, out byte[] saltBytes, out byte[] passwordBytes);
